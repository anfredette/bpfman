...
* Verify that Yaml files have been formatted (see
  [Install Yaml Formatter](../getting-started/building-bpfman.md#install-yaml-formatter))
* Verify that unit tests are passing locally (see
  [Unit Testing](../developer-guide/testing.md#unit-testing)):
```console
cd src/bpfman/
cargo test
```
...
* Verify that integration tests are passing locally (see
  [Basic Integration Tests](../developer-guide/testing.md#basic-integration-tests)):
...
* If developing the bpfman-operator, verify that bpfman-operator integration
  tests are passing locally (see 
  [Kubernetes Integration Tests](../developer-guide/testing.md#kubernetes-integration-tests)):
